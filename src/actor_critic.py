...
class ComicGenerationSystem:
    def __init__(self, config: GenerationConfig):
        ...
        self.critic_prompt_template = """Ты критик комиксов. Оцени качество следующего комикса по критериям:
                        ...
                        7. Проверь что во всех сценах после генерации будет видно лицо того персонажа, который говорит. 
                        8. Проверь все описания сцен на верный формат. Вот так он выглядит.
                        9. Проверь, что если чего-то нет на изображении, то даже упоминания этого нет в тексте. (например фраза "машина уехала" - нельзя, т.к. машины нет в кадре. "Дождь закончился" - нельзя, диффузионка нарисует дождь, поскольку увидит это слово. Очень внимательно проверь текст насчет этого!)
                        [scene]
